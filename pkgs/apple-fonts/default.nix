...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    7z x 'Payload~'
    mv Library/Fonts/* $out/fontfiles
    mkdir -p $out/usr/share/fonts/opentype $out/usr/share/fonts/truetype
    mv $out/fontfiles/*.otf $out/usr/share/fonts/opentype
    mv $out/fontfiles/*.ttf $out/usr/share/fonts/truetype
    rm -rf $out/fontfiles
  '';
