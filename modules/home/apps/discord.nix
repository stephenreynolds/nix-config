...
in
{
  options.my.apps.discord = {
    ...
    autostart = mkEnableOption "Whether to start Discord on login";
    discocss = {
  ...
  config = mkIf cfg.enable (mkMerge [
    ...
    (mkIf cfg.autostart {
      xdg.configFile."autostart/discord-stable.desktop".text = ''
        [Desktop Entry]
    ...
    (mkIf cfg.betterdiscord.enable {
      ...
      xdg.configFile."BetterDiscord/themes/rose-pine.theme.css" = {
      ...
      xdg.configFile."discocss/custom.css" = {
        ...
        text =
          ...
          in /* scss */ ''
            ...
            body {
                font-family: ${config.my.desktop.fonts.profiles.regular.family}, sans serif;
            }
            .scroller-1Bvpku {
