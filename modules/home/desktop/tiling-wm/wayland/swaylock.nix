...
let
  cfg = config.my.desktop.tiling-wm.wayland.swaylock;
...
in
{
  options.my.desktop.tiling-wm.wayland.swaylock = {
  ...
  config = lib.mkIf cfg.enable {
    programs.swaylock = {
      ...
      settings = {
        ...
        font = config.my.desktop.fonts.profiles.regular.family;
        font-size = 15;
